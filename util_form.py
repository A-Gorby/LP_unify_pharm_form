def form_param(fn_list):
    ...
    check_box = Box([Label(value='Выберите Excel-файл:'), fn_check_file_drop_douwn], layout=form_item_layout) 
    ...
    return form, fn_check_file_drop_douwn, sheet_name_drop_douwn
